...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private TextView mNewAccountView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewAccountView = (TextView) findViewById(R.id.new_account_textview);

        mNewAccountView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                createNewAccount();
            }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //TODO: Replace this
            startActivity(new Intent(LoginActivity.this, NewProductActivity.class));
        }
    }
